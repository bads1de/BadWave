  ...
  return (
    <section className="relative">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 group/header px-1 sm:px-2">
        <SectionHeader
          title="TRENDING_NOW"
          subtitle="ANALYZING_GLOBAL_STREAM_METRICS"
          className="mb-0"
          barClassName="h-12 w-1.5 bg-theme-500 shadow-[0_0_20px_rgba(var(--theme-500),1)] animate-pulse"
          titleClassName="text-4xl font-bold text-white tracking-[0.2em] uppercase font-mono drop-shadow-[0_0_12px_rgba(var(--theme-500),0.8)]"
        />
        <TrendPeriodSelector
